...
const LeakageAlerts = () => {
  ...
  const handleMarkAllRead = async () => {
    ...
    try {
      ...
      // Ideally, create a backend endpoint for this. 
      // For now, we loop requests (Acceptable for < 20 alerts, but backend batching is better)
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-grow min-w-0">
                          ...
                          {/* RECOMMENDATION (Optional expansion) */}
