    ...
    <div className="min-h-screen flex flex-col">
      <div className="flex-grow flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-md">
          <div className="card">
            <div className="p-8">
              <h3 className="text-2xl font-bold text-center mb-6 text-gray-900 dark:text-white">Sign In</h3>
              
              {serverError && (
                <div className={`alert ${serverError.includes('Unable to connect') ? 'bg-yellow-100 text-yellow-800' : 'alert-danger'} mb-4`}>
                  {serverError}
                </div>
              )}
